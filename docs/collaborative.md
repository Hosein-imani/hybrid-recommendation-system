...
برای آموزش مدل، ارزیابی آن، ذخیره‌ی artifact  و تولید یک نمونه از پیشنهادها:
...
- ارزیابی RMSE که خطاهای بزرگ‌تر را با شدت بیشتری جریمه می‌کند.
- ارزیابی MAE که میانگین قدرمطلق خطاهای پیش‌بینی را نشان می‌دهد.
