...
pipeline مشترک داده وظایف زیر را انجام می‌دهد:
...
pipeline فعلی hybrid چند عنوان فیلم اولیه را می‌پذیرد، شناسه‌ی آن‌ها را پیدا می‌کند و سپس آن‌ها را برای ساخت profile محتوایی به ماژول content-based می‌دهد.
